...
-- tạo bảng đồ chơi
CREATE TABLE [dbo].[tDoChoi](
	[MaDoChoi] [nvarchar](10) primary key NOT NULL,
	[TenDoChoi] [nvarchar](200) NULL,
...
GO
ALTER TABLE [dbo].[tChiTietHDB]  WITH CHECK ADD  CONSTRAINT [FK_tChiTietHDB_tDoChoi] FOREIGN KEY([MaDoChoi])
REFERENCES [dbo].[tDoChoi] ([MaDoChoi])
GO
ALTER TABLE [dbo].[tChiTietHDB] CHECK CONSTRAINT [FK_tChiTietHDB_tDoChoi]
GO
...
GO
ALTER TABLE [dbo].[tChiTietHDN]  WITH CHECK ADD  CONSTRAINT [FK_tChiTietHDN_tDoChoi] FOREIGN KEY([MaDoChoi])
REFERENCES [dbo].[tDoChoi] ([MaDoChoi])
GO
ALTER TABLE [dbo].[tChiTietHDN] CHECK CONSTRAINT [FK_tChiTietHDN_tDoChoi]
GO
...
GO
ALTER TABLE [dbo].[tDoChoi]  WITH CHECK ADD  CONSTRAINT [FK_tDoChoi_tThuongHieu] FOREIGN KEY([MaThuongHieu])
REFERENCES [dbo].[tThuongHieu] ([MaThuongHieu])
GO
ALTER TABLE [dbo].[tDoChoi] CHECK CONSTRAINT [FK_tDoChoi_tThuongHieu]
GO
ALTER TABLE [dbo].[tDoChoi]  WITH CHECK ADD  CONSTRAINT [FK_tDoChoi_tTheLoai] FOREIGN KEY([MaTheLoai])
REFERENCES [dbo].[tTheLoai] ([MaTheLoai])
GO
ALTER TABLE [dbo].[tDoChoi] CHECK CONSTRAINT [FK_tDoChoi_tTheLoai]
GO
-- procedure login
...
-- insert Thể loại
INSERT [dbo].[tTheLoai] ([MaTheLoai], [TenTheLoai]) VALUES (N'TL01', N'Đồ chơi sáng tạo')
INSERT [dbo].[tTheLoai] ([MaTheLoai], [TenTheLoai]) VALUES (N'TL02', N'Đồ chơi lắp ghép')
INSERT [dbo].[tTheLoai] ([MaTheLoai], [TenTheLoai]) VALUES (N'TL03', N'Búp bê')
INSERT [dbo].[tTheLoai] ([MaTheLoai], [TenTheLoai]) VALUES (N'TL04', N'Mô hình')
INSERT [dbo].[tTheLoai] ([MaTheLoai], [TenTheLoai]) VALUES (N'TL05', N'Thú nhồi bông')
GO

-- insert Thương hiệu

INSERT [dbo].[tThuongHieu] ([MaThuongHieu], [TenThuongHieu]) VALUES (N'TH01', N'Lego')
INSERT [dbo].[tThuongHieu] ([MaThuongHieu], [TenThuongHieu]) VALUES (N'TH02', N'NERF')
INSERT [dbo].[tThuongHieu] ([MaThuongHieu], [TenThuongHieu]) VALUES (N'TH03', N'STAR WAR')
INSERT [dbo].[tThuongHieu] ([MaThuongHieu], [TenThuongHieu]) VALUES (N'TH04', N'AMONG US')
INSERT [dbo].[tThuongHieu] ([MaThuongHieu], [TenThuongHieu]) VALUES (N'Th05', N'BARBIE')
INSERT [dbo].[tThuongHieu] ([MaThuongHieu], [TenThuongHieu]) VALUES (N'TH06', N'MARVEL')
INSERT [dbo].[tThuongHieu] ([MaThuongHieu], [TenThuongHieu]) VALUES (N'TH07', N'DC')
INSERT [dbo].[tThuongHieu] ([MaThuongHieu], [TenThuongHieu]) VALUES (N'TH08', N'HEYONE')
INSERT [dbo].[tThuongHieu] ([MaThuongHieu], [TenThuongHieu]) VALUES (N'TH09', N'LEAGUE OF LEGEND')
Go

-- insert chất liệu

INSERT [dbo].[tChatLieu] ([MaChatLieu], [TenChatLieu]) VALUES (N'CL01', N'Nhựa')
INSERT [dbo].[tChatLieu] ([MaChatLieu], [TenChatLieu]) VALUES (N'CL02', N'Inox')
INSERT [dbo].[tChatLieu] ([MaChatLieu], [TenChatLieu]) VALUES (N'CL03', N'Sắt')
INSERT [dbo].[tChatLieu] ([MaChatLieu], [TenChatLieu]) VALUES (N'CL04', N'Cacbon')
INSERT [dbo].[tChatLieu] ([MaChatLieu], [TenChatLieu]) VALUES (N'CL05', N'Nhựa dẻo')
Go

-- inssert tDoChoi
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'G01', N'Adidas 8681 ', N'CL01', N'TL01', N'TH03', 100000.0000, 108000.0000, 120, 365, N'638 gram', NULL,N'Nữ',N'Trắng')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'G02', N'Nike Air Force 1 ', N'CL02', N'TL01', N'TH04', 60000.0000, 69000.0000, 70, 41, N'440 gram', NULL,N'Unisex',N'Đen')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'G03', N'Adidas Ultra Boost', N'CL04', N'TL06', N'TH05', 105000.0000, 115000.0000, 45, 40, N'450 gram', NULL,N'Unisex', N'Xanh')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'G04', N'Nike Jordan 1','CL05', N'TL01', N'TH01', 65000.0000, 89000.0000, 78, 39, N'374 gram', NULL,N'Unisex', N'Xanh')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'G05', N'Adidas Ultra Boost', N'CL03', N'TL05', N'TH07', 245000.0000, 272000.0000, 56, 36, N'902 gram', NULL,N'Nam', N'Đỏ-Đen')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S06', N'Giày MLB Mustard NY ', N'CL04', N'TL05', N'TH02', 64000.0000, 78000.0000, 89, 37, N'650 gram', NULL,N'Nam', N'Đỏ-Đen')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S07', N'Adidas Alphabounce Beyond REP', N'CL01', N'TL03', N'TH03', 135000.0000, 149000.0000, 68, 38, N'720 gram', NULL,N'Nữ',N'Trắng')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S08', N'Nike Air Force 1 Travis Scott ', N'CL01', N'TL04', N'TH08', 80000.0000, 92000.0000, 45, 482, N'500 gram', NULL,N'Unisex', N'Xanh')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S09', N'Nike Jordan 2', N'Giả da', N'TL02', N'TH09', 41000.0000, 48000.0000, 79, 39, N'480 gram', NULL,N'Nữ',N'Trắng')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S10', N'Adidas Alphabounce New 22 ', N'CL05', N'TL05', N'TH10', 115000.0000, 130000.0000, 43, 40, N'506 gram', NULL,N'Nữ',N'Trắng')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S11', N'Vans Old Skool ', N'CL01', N'TL02', N'TH11', 110000.0000, 150000.0000, 80, 41, N'500 gram', NULL,N'Nam', N'Đỏ-Đen')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S12', N'Giày Converse', N'CL05', N'TL02', N'TH12', 100000.0000, 130000.0000, 80, 42, N'400 gram', NULL,N'Nữ',N'Trắng')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S13', N'Vans Classic Caro F1', N'CL03', N'TL01', N'TH13', 100000.0000, 140000.0000, 80, 43, N'330 gram', NULL,N'Unisex', N'Xanh')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S14', N'Xsport Prophere 4', N'CL02', N'TL01', N'TH14', 200000.0000, 250000.0000, 60, 40, N'200 gram', NULL,N'Nữ',N'Trắng')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S15', N'Adidas Superstar', N'CL04', N'TL01', N'TH15', 200000.0000, 300000.0000, 40, 41, N'500 gram', NULL,N'Nam', N'Đỏ-Đen')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S16', N'Vans Vault Old Skool', N'CL02', N'TL01', N'TH16', 200000.0000, 300000.0000, 50, 42, N'300 gram', NULL,N'Nữ',N'Trắng')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S17', N'Adidas EQT Bask Adv ', N'Giả da', N'TL01', N'TH17', 250000.0000, 300000.0000, 30, 43, N'400 gram', NULL,N'Nữ',N'Trắng')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S18', N'Converse 1970s', N'CL01', N'TL01', N'TH18', 300000.0000, 400000.0000, 60, 40, N'500 gram', NULL,N'Nữ',N'Trắng')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S19', N'Adidas Prophere Xanh Dương Rep', N'CL03', N'TL01', N'TH04', 300000.0000, 450000.0000, 60, 39, N'400 gram', NULL,N'Unisex', N'Xanh')
INSERT [dbo].[tDoChoi] ([MaDoChoi], [TenDoChoi], [MaChatLieu], [MaTheLoai], [MaThuongHieu], [DonGiaNhap], [DonGiaBan], [SoLuong], [KichThuoc], [TrongLuong], [Anh],[GioiTinh],[MauSac]) VALUES (N'S20', N'Adidas Tubular Shadow ', N'CL02', N'TL01', N'TH05', 300000.0000, 400000.0000, 80, 38, N'300 gram', NULL,N'Nam', N'Đỏ-Đen')
GO
select * from tDoChoi
...
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB01', N'G01', 7, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB01', N'G02', 10, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB01', N'G04', 10, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB02', N'G04', 9, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB02', N'G05', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB03', N'G02', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB03', N'G06', 7, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB03', N'G08', 11, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB04', N'G03', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB04', N'G04', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB04', N'G10', 9, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB05', N'G05', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB05', N'G06', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB05', N'G08', 14, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB06', N'G02', 13, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB06', N'G05', 1, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB06', N'G10', 4, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB06', N'G11', 4, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB07', N'G01', 10, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB07', N'G06', 4, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB07', N'G08', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB08', N'G01', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB08', N'G06', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB08', N'G07', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB09', N'G03', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB09', N'G06', 1, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB09', N'G09', 6, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB10', N'G07', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB10', N'G11', 6, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB10', N'G13', 6, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB11', N'G04', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB11', N'G08', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB11', N'G11', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB12', N'G05', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB12', N'G09', 4, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB12', N'G12', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB13', N'G02', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB13', N'G03', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB13', N'G04', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB14', N'G10', 8, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB14', N'G10', 9, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB14', N'G11', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB14', N'G10', 10, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB14', N'G11', 7, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB15', N'G11', 10, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB15', N'G02', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB15', N'G03', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB15', N'G04', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB16', N'G02', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB16', N'G03', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB16', N'G04', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB16', N'G08', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB17', N'G14', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB17', N'G12', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB17', N'G15', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB18', N'G20', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB19', N'G10', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB19', N'G03', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB19', N'G06', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB20', N'G15', 2, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB20', N'G15', 3, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB20', N'G20', 5, NULL)
INSERT [dbo].[tChiTietHDB] ([SoHDB], [MaDoChoi], [SLBan], [KhuyenMai]) VALUES (N'HDB20', N'G10', 2, NULL)
GO
...
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN01', N'G01', 20, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN02', N'G20', 10, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN03', N'G03', 20, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN04', N'G09', 10, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN05', N'G15', 15, NULL)
GO
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN06', N'S01', 20, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN07', N'S06', 10, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN08', N'S03', 20, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN09', N'S09', 10, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN10', N'G10', 15, NULL)
GO
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN11', N'G09', 20, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN12', N'G06', 10, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN13', N'G07', 20, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN14', N'G05', 10, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN15', N'G06', 15, NULL)
GO
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN16', N'G05', 20, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN17', N'G04', 10, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN18', N'G03', 20, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN19', N'G02', 10, NULL)
INSERT [dbo].[tChiTietHDN] ([SoHDN], [MaDoChoi], [SLNhap], [KhuyenMai]) VALUES (N'HDN20', N'G01', 15, NULL)
GO
...
begin
	...
	delete from tDoChoi where MaThuongHieu=@mathuonghieu
...
begin
	...
	delete from tDoChoi where MaTheLoai=@matheloai
...
begin
	...
	delete from tDoChoi where MaChatLieu=@machatlieu
...
create function TinhDoanhThu (@tungay varchar(20),@denngay varchar(20)) returns table as return(
	select SUM(SLBan*DonGiaBan) as TongTien from tDoChoi g join tChiTietHDB cthdb on g.MaDoChoi=cthdb.MaDoChoi
...
create function SanPhamBan (@tungay varchar(20),@denngay varchar(20)) returns table as return(
	select g.MaDoChoi,TenDoChoi,DonGiaBan,SLBan,NgayBan,SUM(SLBan*DonGiaBan) as TongTien from tDoChoi g join tChiTietHDB cthdb on g.MaDoChoi=cthdb.MaDoChoi
	join tHoaDonBan hdb on hdb.SoHDB=cthdb.SoHDB
	where NgayBan between @tungay and @denngay
	group by g.MaDoChoi,TenDoChoi,DonGiaBan,SLBan,NgayBan
)
go
...
create function TinhTienNhap (@tungay varchar(20),@denngay varchar(20)) returns table as return(
	select SUM(SLNhap*DonGiaNhap) as TongTien from tDoChoi g join tChiTietHDN cthdn on g.MaDoChoi=cthdn.MaDoChoi
...
create function SanPhamNhap (@tungay varchar(20),@denngay varchar(20)) returns table as return(
	select g.MaDoChoi,TenDoChoi,DonGiaNhap,SLNhap,NgayNhap, SUM(SLNhap*DonGiaNhap) as TongTien from tDoChoi g join tChiTietHDN cthdn on g.MaDoChoi=cthdn.MaDoChoi
	join tHoaDonNhap hdn on hdn.SoHDN=cthdn.SoHDN
	where NgayNhap between @tungay and @denngay
	group by g.MaDoChoi,TenDoChoi,DonGiaNhap,SLNhap,NgayNhap
)
go
...
(
	select  NgayBan,cthdb.SoHDB,TenDoChoi,SLBan,DonGiaBan,SLBan*DonGiaBan as dt 
	from tHoaDonBan hdb join tChiTietHDB cthdb on hdb.SoHDB=cthdb.SoHDB
	join tDoChoi g on g.MaDoChoi=cthdb.MaDoChoi
